...
if predict == False:
    ...
    print pseudodf.shape
    ps_vects.append(csr_matrix(pseudodf))
    X_pseudo_stack = hstack(ps_vects, 'csr')
...
model1.save_model('models/uplgb_pseudo.txt')
del model1
gc.collect()
exit(0)
